      ...
      return {
        ...
        wavePalette: [
          ...
          },
          {
            ...
            amplitude: 95,
            frequency: 0.0028,
            color: resolveColor(['--muted-foreground', '--foreground'], 0.45),
            opacity: 0.55,
            speed: 0.0022,
            chaos: 1.3,
            attraction: -0.85,
          ...
          },
          {
            ...
            amplitude: 160,
            frequency: 0.0032,
            color: resolveColor(['--ring', '--primary'], 0.55),
            opacity: 0.75,
            speed: 0.0026,
            chaos: 0.9,
            attraction: 0.55,
          ...
          },
          {
            ...
            amplitude: 130,
            frequency: 0.0025,
            color: resolveColor(['--chart-3', '--accent', '--primary'], 0.45),
            opacity: 0.5,
            speed: 0.002,
            chaos: 1.4,
            attraction: -0.5,
          ...
          },
          {
            ...
            amplitude: 210,
            frequency: 0.0038,
            color: resolveColor(['--chart-2', '--muted-foreground', '--foreground'], 0.3),
            opacity: 0.4,
            speed: 0.003,
            chaos: 1.2,
            attraction: 0.35,
