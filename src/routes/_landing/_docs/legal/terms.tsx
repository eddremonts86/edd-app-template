...
function TermsPage() {
  ...
  return (
    ...
    >
      <p>Please read these terms of use carefully before using this application template.</p>

      <h2 id="usage-terms">Open-Source Usage</h2>
      <p>
        This application template is provided as open-source software under the MIT License. You are
        free to copy, modify, distribute, and use the code for both commercial and non-commercial
