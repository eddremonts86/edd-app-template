  ...
  return (
    ...
    >
      ...
      <ol>
        ...
        <li>
          <strong>Install dependencies:</strong> Make sure you have <a href="https://pnpm.io/" target="_blank" rel="noopener noreferrer">pnpm</a> installed.
          <pre className="p-3 rounded-lg bg-muted text-xs font-mono">
        ...
        <li>
          ...
          Open <a href="http://localhost:3000" target="_blank" rel="noopener noreferrer">http://localhost:3000</a> in your browser to verify the installation.
        </li>
      </ol>
      ...
      <ul>
        <li>
          <strong>Theme Colors:</strong> Open <code>src/shared/styles/globals.css</code> and update the <code>--primary</code>, <code>--radius</code>, and <code>--background</code> values in the <code>:root</code> (light) and <code>.dark</code> (dark) blocks.
        </li>
        <li>
          <strong>Logos & Copy:</strong> Modify the landing page layouts and text located in <code>src/modules/landing/components/</code>.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          Ensure you maintain strict <a href="/starter/conventions">module boundaries</a> to prevent changes in one area from breaking other parts of your app.
        </li>
      </ul>
      ...
      <ol>
        <li>
          Configure your production environment variables (database credentials, Clerk API keys, Sentry endpoints) in your hosting dashboard.
        </li>
        <li>
          Ensure database migrations run automatically during deployment by adding the migration step to your build commands or release phases:
          <pre className="p-3 rounded-lg bg-muted text-xs font-mono">
